function googlereviewscomponent() {
    return <>
        <div class="row home-google-reviews-api-border-row home-default-settings">
            <div class="home-background-color home-google-reviews-api-border-width">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 home-review-row home-margin-top-review-row">
            ...
            <div class="home-background-color-two home-google-reviews-api-border-width">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-xs-12 home-google-resize-reviews">
